  ...
  return (
    <div>
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-hairline bg-surface">
        {rows.length === 0 ? (
          <p className="p-8 text-center text-sm text-ink-muted">Nothing to review.</p>
        ) : (
                        ...
                        {r.status === "pending" ? (
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              className="rounded-md bg-navy px-3 py-1 text-xs font-600 text-primary-foreground"
                            >
                              Approve
                            </button>
                            <button
                              onClick={() => act(r.id, false)}
                              className="rounded-md border border-hairline bg-surface px-3 py-1 text-xs font-600 text-destructive"
                            >
                              Reject
                            </button>
                          </div>
