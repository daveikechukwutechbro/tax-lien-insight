...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Chicago TaxLien Auctions — Tax Lien Certificates & Auction Marketplace" },
      ...
      { name: "author", content: "Chicago TaxLien Auctions" },
      { property: "og:site_name", content: "Chicago TaxLien Auctions" },
      { property: "og:title", content: "Chicago TaxLien Auctions" },
